...
def get_cls_map(net, device, all_data_loader, y):
    ...
    classification_map(y_re, y, 300,
                       'classification_maps/' + args.dataset_name +'.eps')
    classification_map(y_re, y, 300,
                       'classification_maps/' + args.dataset_name +'.png')
    classification_map(gt_re, y, 300,
                       'classification_maps/' + args.dataset_name +'_gt.png')
