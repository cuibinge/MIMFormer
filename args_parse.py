...
"""
####################################################################
parser.add_argument('--epochs', type=int, default=100, help='模型迭代次数')
...
parser.add_argument('--test_ratio', type=float, default=0.9, help='测试样本占的比例IP0.9，SV/Honghu 0.99,Coast0.9719')
